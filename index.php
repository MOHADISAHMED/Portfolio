        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h1 class="display-3 mb-3">Mohadis Ahmed</h1>
                    <h2 class="typed-text-output d-inline"></h2>
                    <div class="typed-text d-none">FullStack Developer, Web Designer, Web Developer, Front End Developer, Backend Developer, </div>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="img/dp.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h3 class="fw-bold">mohadistanoli832@gmail.com</h3>
                    <hr class="w-100">
